...
export const settingsDict = {
  ...
  'settings.remoteInstances.clientAuth.field.labelPlaceholder': 'Device name â€” e.g. My iPhone',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': 'Works at home and away. Away traffic goes through OpenChamber Private Relay â€” an end-to-end encrypted tunnel. No setup needed.',
  ...
  'settings.remoteInstances.clientAuth.state.pending': 'Waiting to connectâ€¦',
  'settings.remoteInstances.clientAuth.state.viaRelay': 'Relay',
  'settings.remoteInstances.clientAuth.state.connectedDirect': 'Connected Â· Local network',
  'settings.remoteInstances.clientAuth.state.connectedRelay': 'Connected Â· Relay',
  ...
  'settings.remoteInstances.relay.description': 'Let your other devices connect from anywhere without opening ports. Traffic is end-to-end encrypted â€” the relay cannot read it.',
  ...
  'settings.remoteInstances.relay.pair.noTokenHint': 'Without a token, the device signs in with this serverâ€™s UI password after connecting.',
  ...
  'settings.remoteInstances.relay.pair.manageHint': 'Manage or revoke paired devices in the â€œConnect to this serverâ€ list above.',
  ...
  'settings.agents.page.permissionsEditor.customKeyPlaceholder': 'Custom permission keyâ€¦',
  ...
  'settings.agents.page.permissionsEditor.toast.savedRestartRequired': 'Permissions saved â€” restart the OpenCode server to apply',
  ...
  'settings.behavior.page.systemPromptOptimization.restarting': 'Restarting OpenCode to apply system prompt optimizationâ€¦',
  ...
  'settings.skills.catalog.shared.field.searchSkillsPlaceholder': 'Search skillsâ€¦',
  ...
  'settings.skills.catalog.shared.auth.footerHintArrow': 'Configure identities in Settings â†’ Git Identities.',
  ...
  'settings.openchamber.passkeys.actions.signingOut': 'Signing outâ€¦',
  'settings.openchamber.passkeys.actions.removing': 'Removingâ€¦',
  'settings.openchamber.passkeys.state.uiPasswordRequired': 'Passkeys are available only when the UI password lock is enabled.',
  'settings.openchamber.passkeys.state.loading': 'Loading passkeysâ€¦',
  ...
  'settings.openchamber.opencodeCli.actions.restartingOpenCode': 'Restarting OpenCodeâ€¦',
  ...
  'settings.mcp.sidebar.actions.deleting': 'Deletingâ€¦',
  ...
  'settings.plugins.sidebar.actions.deleting': 'Deletingâ€¦',
  ...
  'settings.plugins.toast.reloadFailed': 'opencode reload failed â€” restart required',
  ...
  'settings.plugins.registry.badge.update.tooltip': 'Update available: {current} â†’ {latest}',
  ...
  'settings.plugins.toast.refreshing': 'Checking npm for updatesâ€¦',
  ...
  'settings.usage.page.header.lastUpdatedWithPlan': 'Plan: {plan} Â· Last updated: {time}',
  ...
  'settings.usage.pace.waitSeparator': ' Â· Wait ',
  ...
  'settings.agents.modelSelector.keyboardHints': 'â†‘â†“ navigate â€¢ Enter select â€¢ Esc close',
  ...
  'settings.providers.page.auth.oauth.starting': 'Starting authorizationâ€¦',
  'settings.providers.page.auth.oauth.waiting': 'Waiting for authorizationâ€¦',
  'settings.providers.page.auth.oauth.waitingHint': 'Finish signing in in your browser. Keep this page open â€” the connection completes on its own.',
  ...
  'settings.providers.page.auth.oauth.promptRequired': 'Fill in â€œ{field}â€ to continue',
  ...
  'settings.providers.page.auth.incompleteHint': 'Â· Add an API key or {env:VAR} before using this provider in chat',
  'settings.providers.page.auth.useReconnectHint': 'Â· Use Reconnect to update credentials',
  ...
  'settings.mcp.page.transport.remote': 'Remote Â· SSE',
  ...
  'settings.mcp.page.status.description.awaitingRestart': 'This server is saved but not applied yet. Use Apply & Restart to load it into OpenCode â€” connect and authorization become available after that.',
  ...
  'settings.mcp.page.actions.deleting': 'Deletingâ€¦',
  ...
  'settings.mcp.page.env.plainTextWarning': 'âš  Values are stored as plain text in opencode.json',
  ...
  'settings.mcp.page.toast.serverCreatedReloading': 'MCP server created. OpenCode reloadingâ€¦',
  'settings.mcp.page.toast.savedReloading': 'Saved. OpenCode reloadingâ€¦',
  ...
  'settings.github.page.flow.waiting': 'Waiting for approvalâ€¦ (auto-refresh)',
  ...
  'settings.openchamber.visual.actions.restarting': 'Restartingâ€¦',
  ...
  'settings.magicPrompts.page.group.sessionExplore.description': 'Prompts used by the /explore slash command: visible user message + hidden instructions. Investigates the repository and gives a structured orientation â€” the big picture, main modules, how they connect, and where to start â€” rather than a file-by-file dump.',
  ...
  'settings.magicPrompts.page.group.sessionCatchUp.description': 'Prompts used by the /catch-up slash command: visible user message + hidden instructions. Builds branch-aware context â€” the branch\'s commits, its PR, and uncommitted work together â€” to understand what you were doing, then gives a digestible summary and a product-focused next step.',
  'settings.magicPrompts.page.group.sessionDebug.title': 'Debugging',
  'settings.magicPrompts.page.group.sessionDebug.description': 'Prompts used by the /debug slash command: visible user message + hidden instructions. Runs a guided root-cause investigation â€” captures the symptom, forms hypotheses, checks them against the code, and confirms the cause before proposing a fix.',
  'settings.magicPrompts.page.group.sessionWeigh.title': 'Weigh Options',
  'settings.magicPrompts.page.group.sessionWeigh.description': 'Prompts used by the /weigh slash command: visible user message + hidden instructions. Investigates the code, then lays out 2-3 distinct approaches with trade-offs and a recommendation â€” without writing a plan or code.',
