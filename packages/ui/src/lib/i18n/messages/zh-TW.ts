...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.project.actions.refreshProject': 'Refresh project',  'sessions.sidebar.project.actions.refreshProjectTooltip': 'Refresh project sessions and folders',  'sessions.sidebar.project.actions.newDraftSession': '新增草稿會話',
