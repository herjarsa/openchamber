...
export const dict = {
  ...
  'sessions.sidebar.project.actions.refreshProject': 'Refresh project',  'sessions.sidebar.project.actions.refreshProjectTooltip': 'Refresh project sessions and folders',  'sessions.sidebar.project.actions.newDraftSession': 'New draft session',
