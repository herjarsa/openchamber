...
export const SETTINGS_PAGE_METADATA: readonly SettingsPageMeta[] = [
  ...
  { slug: 'integrations', title: 'Integrations', group: 'general', kind: 'single', keywords: ['integration', 'plugin', 'provider', 'oauth', 'claude', 'cursor', 'command code', 'connect', 'discord', 'telegram', 'messenger', 'slack', 'chat', 'jira', 'atlassian', 'issue', 'tracker'] },
] as const;
